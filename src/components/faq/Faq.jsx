...
const Faq = () => {
    return (
        ...
        <div className="all-privacy-and-others pb-5 mb-5">
          ...
          <h3>OVERVIEW</h3>
          <p>
          Here are some steps that everyone can follow to ensure their faq while using KIQKO.com. Please take a few minutes to read these tips.
          </p>
