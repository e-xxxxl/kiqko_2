    ...
    return (
        <CommonLayout>
            ...
            <div className="all-container-inner">
                <div className="search-location-you">
                    <Container>
                        <Row>
                            <Col md={12}>
                                <div className="about-field-style">
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control className="input-head" type="email" placeholder="Input name of city / town" />
                            ...
                            <Col className="mt-2" md={12}>
                                <div className="about-field-style">
                                    <Form.Group className="mb-3">
                                        ...
                                        <Form.Control className="input-head" type="email" placeholder="Input name of state / province" />
                            ...
                            <span className="span-notic">(Hold "Shift" on PC or hold "Command" on Mac for multiple selections)</span>
                                <div className="about-field-stylen select-search">
                        ...
                        <Row>
                            <Col className="mt-12 mt-custom-cont mb-5 pb-5 text-center" md={12}>
                                <NavLink exact to="/">
                                    <Button className="all-btn-round mt-4 text-start" variant="primary">Continue <MdOutlineArrowForward className="arrow-sign position-arrow"/></Button>
                                </NavLink>
                            </Col>
                        </Row>
                    </Container>
