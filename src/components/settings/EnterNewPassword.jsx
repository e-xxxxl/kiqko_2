    ...
    <Col md={9}>
        <div className="profile-main-part-area-inner setting-area bg-all-pages mb-0-see">
            ...
            <div className="all-seting-area-pass">
                    <Row>
                    <div md={12} className="mt-4"><p className="p-up-loc text-left">Password is case sensitive and must contain:</p></div>
                        ...
                        <Row className="mt-3">
                        <Col md={6}>
                        <Form.Control className="input-settings text-center" type="password" placeholder="New Password" />
                        </Col>
                        <Col md={6}>
                        <Form.Control className="input-settings text-center" type="password" placeholder="Confirm New Password" />
                            </Col>
                            <Col md={6} className="text-center offset-md-3">
                            <Button className="settings-btn mt-5" variant="primary">Reset Password</Button>
                            </Col>
                        </Row>
