...
To be a verified member you need to add a minimum of five photos.
                   ...
                   <Col className="photo-list-all custom-4-grid" md={4}>
                       <p className="p-p-profile">Your profile photo</p>
                        ...
                        <Form.Control className="text-media2" as="textarea" rows={3} value="" />
                       
                   </Col>
                       <Col className="photo-list-all-media custom-8-grid p-0" md={8}>
                           <ul>
                               <li className="border-0">
                                   <div className="add-photo-media">
                                       <input type="file" />
                                   </div>
                               </li>
                   ...
                   <Row>
                       <Col className="mt-12 text-center" md={12}>
                           <NavLink exact to="/profile">
                               <Button className="all-btn-round mt-5 text-left font-segoeui" variant="primary">Save<MdOutlineArrowForward className="arrow-sign arrowba" /></Button>
                           </NavLink>
                       </Col>
                   </Row>
        </div>   
